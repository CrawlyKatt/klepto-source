...
IMPLEMENT_SERVERCLASS_ST(CBaseAnimating, DT_BaseAnimating)
	...
	SendPropFloat	( SENDINFO(m_flPlaybackRate), ANIMATION_PLAYBACKRATE_BITS, SPROP_ROUNDUP, -4.0, 10.0f ), // NOTE: if this isn't a power of 2 than "1.0" can't be encoded correctly
